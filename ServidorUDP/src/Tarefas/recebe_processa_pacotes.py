...
class ProcessaPacotes(object):
    ...
    def __cria_processo(self, pacote):
        ...
        #taskMgr.add(self.__handler.execute_acao,'Sub-RecebeProcessaPacotes',sort=self.__sort,extraArgs=[pacote],appendTask=True,uponDeath=self.__remove_processo)            
